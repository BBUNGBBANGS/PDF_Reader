...
void Append(unsigned char * str, const uint8_t* bytes, size_t length, CharacterSet_t charset)
{
	strncat(str, bytes, length);
	return;
}
...
*/
CharacterSet_t GuessEncoding(const uint8_t* bytes, size_t length, CharacterSet fallback)
{
